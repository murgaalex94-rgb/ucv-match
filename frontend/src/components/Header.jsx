    ...
    <div className="flex items-center gap-4">
      <div className="relative" ref={notifRef}>
        <button
          ...
          className="relative p-2 bg-gray-100 rounded-full text-gray-600 hover:bg-gray-200"
        >
      ...
      <div className="relative" ref={userRef}>
        <div
          ...
          className="flex items-center gap-2 bg-white border border-gray-200 rounded-full pl-1 pr-3 py-1 cursor-pointer hover:bg-gray-50 transition-colors"
        >
          <div className="w-8 h-8 bg-[#0f2a5c] rounded-full overflow-hidden flex items-center justify-center text-white text-xs font-bold">
            {avatarUrl ? (
          ...
          <span className="text-sm font-medium text-gray-700">{nombreUsuario || 'Usuario'}</span>
